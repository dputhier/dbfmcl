...
Alternatively the cluster obtained can be represented using a heatmap (thanks to the *type* argument):
...
# Comparing with DBFMCL gene filtering with variance stabilizing transformation
...
# Perform alternative cell ordering
